...
public class CallDirectionConfiguration : IEntityTypeConfiguration<CallDirection>
{
    public void Configure(EntityTypeBuilder<CallDirection> builder)
    {
        builder.ToTable("call_directions");

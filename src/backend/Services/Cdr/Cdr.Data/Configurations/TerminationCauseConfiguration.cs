...
public class TerminationCauseConfiguration : IEntityTypeConfiguration<TerminationCause>
{
    public void Configure(EntityTypeBuilder<TerminationCause> builder)
    {
        builder.ToTable("termination_causes");
        ...
        builder.Property(x => x.Q850Code).HasColumnName("q850_code");

...
public class DestinationGroupsEndpointTests : BaseRateTest, IAsyncLifetime
{
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/rates/destination-groups");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/rates/destination-groups/1");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/rates/destination-groups/999");
    ...
    public async Task Create_ValidRequest_ReturnsCreatedGroup()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/api/rates/destination-groups", request);
    ...
    public async Task Update_ValidRequest_ReturnsUpdatedGroup()
    {
        ...
        // Act
        var response = await _client.PutAsJsonAsync("/api/rates/destination-groups/1", updateRequest);

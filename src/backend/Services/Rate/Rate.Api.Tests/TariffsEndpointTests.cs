...
public class TariffsEndpointTests : BaseRateTest, IAsyncLifetime
{
    ...
    public async Task GetList_ReturnsTariffs()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/api/rates/tariffs/list", filter);
    ...
    public async Task GetByGid_ExistingTariff_ReturnsTariff()
    {
        ...
        var response = await _client.GetAsync(
            $"/api/rates/tariffs/{RateServiceTestDataSeeder.TestTariffGid}");
    ...
    {
        // Act
        var response = await _client.GetAsync("/api/rates/tariffs/non-existing-gid");
    ...
    public async Task Create_ValidRequest_ReturnsCreatedTariff()
    {
        ...
        // Act
        var response = await _client.PostAsJsonAsync("/api/rates/tariffs", request);
    ...
    public async Task Update_ValidRequest_ReturnsUpdatedTariff()
    {
        ...
        var response = await _client.PutAsJsonAsync(
            $"/api/rates/tariffs/{RateServiceTestDataSeeder.TestTariffGid}", request);
    ...
    public async Task Delete_NonDefaultTariff_ReturnsSuccess()
    {
        ...
        var createResponse = await _client.PostAsJsonAsync("/api/rates/tariffs", createRequest);
        var created = await createResponse.Content.ReadFromJsonAsync<TariffResponse>();

        // Act
        var response = await _client.DeleteAsync($"/api/rates/tariffs/{created!.Gid}");

...
public static class Endpoint
{
    ...
    public static void MapDestinationGroupEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        // POST /api/rates/destination-groups
        ...
        // PUT /api/rates/destination-groups/{id}
